...
class InfoWebsiteMahasiswa extends StatefulWidget {
  const InfoWebsiteMahasiswa({super.key});
  @override
  _InfoWebsiteState createState() => _InfoWebsiteState();
}

class _InfoWebsiteState extends State<InfoWebsiteMahasiswa> {
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              ...
              Navigator.of(context).pushNamed("/homemahasiswa");
            },
          ),
